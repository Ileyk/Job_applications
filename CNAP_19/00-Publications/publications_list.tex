...
\noindent\makebox[0.1\textwidth][l]{Fb 2019} 12$^{\text{th}}$ INTEGRAL conference - Geneva, (SW)\\
\vspace*{0.1cm}
\noindent\makebox[0.1\textwidth][l]{Oc 2018} Stellar Winds in Massive X-ray Binaries workshop - Santander (SP) - \textbf{invited}\\
\vspace*{0.1cm}
\noindent\makebox[0.1\textwidth][l]{Oc 2018} Leuven-Amsterdam-Bonn massive stars meeting - Leuven (BE)\\
\vspace*{0.1cm}
\noindent\makebox[0.1\textwidth][l]{Ag 2018} IAU General Assembly - High Mass X-ray Binaries symposium - Vienna, AT\\
\vspace*{0.1cm}
\noindent\makebox[0.1\textwidth][l]{Jn 2018} Belgium FNRS meeting - Brussels, BE\\
\vspace*{0.1cm}
...
\begin{flushleft}
\noindent\makebox[0.1\textwidth][l]{Fb 2019} APC Paris 7 Diderot (FR)\\
\vspace*{0.1cm}
\noindent\makebox[0.1\textwidth][l]{Nv 2018} IRAP Toulouse (FR)\\
\vspace*{0.1cm}
\noindent\makebox[0.1\textwidth][l]{Jl 2018} TAPIR Caltech (US)\\
\vspace*{0.1cm}
\noindent\makebox[0.1\textwidth][l]{Fb 2018} LUPM Montpellier (FR)\\
\vspace*{0.1cm}
...
\begin{flushleft}
\noindent\makebox[0.1\textwidth][l]{Jl 2018} Clumpy wind accretion in Supergiant X-ray binaries, COSPAR Pasadena (US)\\
\vspace*{0.1cm}
