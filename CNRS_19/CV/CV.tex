...
~      & \hspace*{-1.5cm}\emph{A possible mass transfer mechanism for Ultraluminous X-ray sources} (2019) - A\&A\\ \\
...
~      & \hspace*{-1.5cm}\emph{Solving the conundrum of the short superwind yields key}\\
~      & \hspace*{-1.5cm}\emph{to maximum mass-loss rate of AGB stars} (under reviewing)\\ \\

~      & \hspace*{-2.0cm}[3] \textbf{El Mellah I.}, Sander A. A. C., Sundqvist J. O. \& Keppens R. [arXiv:1810.12933]\\ 
~      & \hspace*{-1.5cm}\emph{Formation of wind-captured discs in Supergiant X-ray binaries :}\\
~      & \hspace*{-1.5cm}\emph{Consequences for Vela X-1 and Cygnus X-1} (under reviewing)\\ \\
...
~      & \hspace*{-1.5cm}\emph{Wind-captured discs in Supergiant X-ray binaries} (2018) - IAU Vienna\\ \\
